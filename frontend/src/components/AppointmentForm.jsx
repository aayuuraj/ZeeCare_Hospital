...
const AppointmentForm = () => {
  ...
  useEffect(() => {
    const fetchAvailableSlots = async () => {
      if (appointmentDate && doctorFirstName && doctorLastName && department) {
        try {
          const { data } = await axios.get(
            `${import.meta.env.VITE_BACKEND_URL}/api/v1/appointment/available-slots`,
            {
              params: {
    ...
    fetchAvailableSlots();
  }, [appointmentDate, doctorFirstName, doctorLastName, department]);
